...
{
  This example is a combination of the DisplaySPI and DisplayFB examples and illustrates usage of SPI protocol
  and drawing on a TFT display with Ultibo HX8357 driver and framebuffer.

  Attention! Please follow these instructions before running the sample:

   1. Remember to copy accompanying files "corbel.font", "consolas.font" and "smalllenna.png" from the 
...
begin
  FDisplay := TDisplay.Create(FramebufferDeviceFindByDescription(PITFT35_FRAMEBUFFER_DESCRIPTION));
